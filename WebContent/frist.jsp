...
<br>
<button id="create" type="button" style="width: 90px">Create</button><br>
<br>
<button type="button" id="delete" style="width: 90px">Delete</button><br>
<br>
<button type="button" id="update" style="width: 90px">Update</button><br>
<br>
</nav>
...
<h1 id="titel"></h1>
<p id="demo">
<br>THE MIND FORM FOR YOU OPERATIONS
<br>
<br>
<br> 
</p>
